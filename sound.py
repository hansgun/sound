...
class snd_dns_cal :
    def __init__(self, wav_file_str, search_size=21, neighbor_size=13) : 
        self.wav_file_str = wav_file_str
        self.search_size = search_size
        self.neighbor_size = neighbor_size
        print('file_name :', self.wav_file_str, '\t search_size : ', self.search_size, '\t neighbor_size :', self.neighbor_size)
    ...
    def ed_dist(self, nd_1, nd_2, round_arg = 1) :
        ...
        return round(sqrt(sum(temp_nd)),round_arg)
